...
Route::get('/all-requests', [LeaveRequestController::class, 'getAllRequests']);
Route::get('/insert-approved-requests', [LeaveRequestController::class, 'insertApprovedRequestsIntoOgCumul']);
Route::get('manager/{userId}/leave-requests', [LeaveRequestController::class, 'getTeamRequests']);
