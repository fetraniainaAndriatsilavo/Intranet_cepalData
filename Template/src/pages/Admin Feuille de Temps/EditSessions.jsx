...
export default function EditSessions({ open, onClose, sessionsId }) {
    ...
    const fetchSession = (id) => {
        api
            ...
            .catch((error) => {
                console.log(error.response?.data?.message || "Erreur de chargement");
            });
    }; 
    ...
    const cancel = () => {
        setForm({ periode: "", start_date: "", end_date: "", updated_by: user ? user.id : null });
        setError("");
        setSuccess("");
        onClose();
    };
    ...
    const Update = async (e) => {
        ...
        try {
            const response = await api.put(
                "/timesheet-periods/" + sessionsId + "/update",
                form
            );
