...
export default function CardNotification({ notification, fetchNotifications }) {
    ...
    return <div className="p-1">
        <div className="flex items-center flex-row ml-3 mb-1">
            {
                notification.data.title ? <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-bell"><path stroke="none" d="M0 0h24v24H0z" fill="none" />
        ...
        <p className="flex items-center text-justify ml-3">
            {notification.data.message ? notification.data.message : notification.data.content}
        </p>
