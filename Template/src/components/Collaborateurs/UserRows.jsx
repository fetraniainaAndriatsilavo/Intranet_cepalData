...
export default function UserRows({ data, setAllUsers }) {
    ...
    >
        ...
        <td className="px-6 py-4 text-center">{data.position_name}</td>
        <td className="px-6 py-4 text-center">{data.department}</td>
        <td className="px-6 py-4 text-center">{formatDate(data.hire_date)}</td>
            ...
            <div className="flex items-center justify-center gap-3">
                ...
                >
                    <svg
                        ...
                        className="text-gray-300 icon icon-tabler icons-tabler-outline icon-tabler-edit"
                    >
                ...
                <button
                    ...
                    className="cursor-pointer"
                    title={`${data.status == "active" ? "Archiver" : "Restaurer"}`}
                >
                    {data.status === "active" ? (
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            ...
                            strokeLinecap="round"
                            strokeLinejoin="round"
                            className="text-red-500 icon icon-tabler icons-tabler-outline icon-tabler-trash"
                        >
                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                            <path d="M4 7l16 0" />
                            <path d="M10 11l0 6" />
                        ...
                        <svg
                            ...
                            strokeLinecap="round"
                            strokeLinejoin="round"
                            className="text-gray-700 icon icon-tabler icons-tabler-outline icon-tabler-restore"
                        >
                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
