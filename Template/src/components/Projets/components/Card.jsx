...
export default function Card({ data, onDragStart }) {
    const cardStyle = {
        padding: "0.75rem",
        marginBottom: "0.5rem",
        borderRadius: "6px",
    ...
    return (
        <div
            style={cardStyle}
            className="bg-[#fff] hover:cursor-pointer hover:bg-gray-50"
            draggable
            onDragStart={(e) => onDragStart(e, data)}
        >
            <strong>{data.title}</strong>
            <p className="leading-5 text-sm text-justify">{data.description}</p>
            <div className="flex items-center justify-between flex-row mt-3">
                ...
                <span className=" p-0.5 rounded-lg">
                    {
                        data.type == 'Bug' ? <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" className="text-pink-300 icon icon-tabler icons-tabler-filled icon-tabler-bug">
                        ...
                        </svg> : data.type == 'Task' ? <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" className="text-sky-600 icon icon-tabler icons-tabler-filled icon-tabler-clipboard">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                        ...
                        </svg> : data.type == 'Stories' ? <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" className="text-yellow-200 icon icon-tabler icons-tabler-filled icon-tabler-book">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                        ...
                        </svg> : <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="text-green-500 icon icon-tabler icons-tabler-outline icon-tabler-file-isr">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
