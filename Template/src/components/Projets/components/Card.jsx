...
export default function Card({ data, onDragStart, ViewCard }) {
    const cardStyle = {
        padding: "0.75rem",
        marginBottom: "0.5rem",
        borderRadius: "6px",
        ...
        >
            ...
            <div className="flex items-center justify-between flex-row mt-3">
                <AvatarGroup max={3} spacing={"small"}>
                    <Avatar sx={{ width: 32, height: 32, backgroundColor: '#2196f3'}}> {data.assigned_user.last_name.charAt(0) + '' + data.assigned_user.first_name.charAt(0)} </Avatar>
                </AvatarGroup>
