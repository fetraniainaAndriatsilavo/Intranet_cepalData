        ...
        <div className="flex flex-col items-center justify-center gap-3 p-2 py-8 w-2/3 rounded-lg bg-white dark:bg-gray-800">
            ...
            >
                <TextField
                    label="Adresse Email"
                    variant="outlined"
                    className="w-2/3 dark:border-gray-600 dark:bg-gray-700 dark:text-white"
                    name="email"
                    id="email"
                    value={email}
                ...
                <button
                    type="submit"
                    className="p-3 hover:bg-sky-900 text-white rounded-lg mt-3 w-2/3 cursor-pointer transition"
